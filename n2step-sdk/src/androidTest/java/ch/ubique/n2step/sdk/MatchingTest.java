...
public class MatchingTest {
	...
	public void testMatching() {
		...
		N2STEP.addVenueVisit(time - 2 * 60 * 60 * 1000l, time, notificationKey, venuePublicKey, context);
		...
		List<Exposure> exposures = N2STEP.checkForMatches(problematicEvents, context);
	...
	public void testMatchingExitedBefore() {
		...
		N2STEP.addVenueVisit(time - 2 * 60 * 60 * 1000l, time - 30 * 60 * 1000l, notificationKey, venuePublicKey, context);
	...
	public void testMatchingSameTime() {
		...
		N2STEP.addVenueVisit(time - 1 * 60 * 60 * 1000l, time - 10, notificationKey, venuePublicKey, context);
